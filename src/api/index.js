...
export const siteAPI = {
  get: () => axios.get("/public/site"),
  create: (data) => axios.post("/public/site", data),
  update: (id, data) => axios.put(`/public/site/${id}`, data),
  delete: (id) => axios.delete(`/public/site/${id}`),
};
...
export const attendanceAPI = {
  ...
  getStudentReport: (studentId, params) =>
    axios.get(`/attendance/student/${studentId}/report`, { params }),
};
...
export const markAPI = {
  ...
  getStudentResults: (studentId) =>
    axios.get(`/marks/student/${studentId}/results`),
};
...
export const libraryAPI = {
  ...
  returnBook: (id, data) =>
    axios.put(`/library/transactions/${id}/return`, data),
...
export const dashboardAPI = {
  ...
  getAttendanceStats: (params) =>
    axios.get("/dashboard/attendance-stats", { params }),
